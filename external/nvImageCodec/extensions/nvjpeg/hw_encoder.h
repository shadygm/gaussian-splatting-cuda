...
namespace nvjpeg {
    ...
    class NvJpegHwEncoderPlugin {
    public:
        explicit NvJpegHwEncoderPlugin(const nvimgcodecFrameworkDesc_t* framework);
    ...
    private:
        ...
        static constexpr const char* plugin_id_ = "nvjpeg_hw_encoder";
